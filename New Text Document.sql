...
/*
Manual reset helper:
1. Chạy file này để đảm bảo bảng đã tồn tại.
2. Nếu muốn xóa toàn bộ dữ liệu hiện tại bằng SQL, chạy block dưới đây.
3. Sau đó chạy `npm run seed:reset` trong thư mục `backend` để nạp bộ seed mới.
*/
